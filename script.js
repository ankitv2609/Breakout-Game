...
function drawBall() 
{
    ...
    ctx.fillStyle = ball.visible ? '#0095dd' : 'transparent'; // change here
    ctx.fill();
    ctx.closePath();
}
...
function moveBall() 
{
    ...
    //console.log(ball.x, ball.y); // tricky    //debugging tech
...
function update()
{
    ...
    requestAnimationFrame(update); // this made it recursive //tricky
}

update(); //INITIAL ERROR - I missed typing this f*cking call
